...
<body>
<div class="container">
    <h1>👥 Manter Inquilinos</h1>

    <div class="footer-actions" style="justify-content: flex-start; margin-bottom: 20px;">
        <a href="${pageContext.request.contextPath}/inquilino/registrar" class="btn-search" style="text-decoration: none;">+ Adicionar Novo Inquilino</a>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <c:choose>
                    <c:when test="${not empty listaInquilinos}">
                        <c:forEach var="inquilino" items="${listaInquilinos}">
                            <tr>
                                <td>${inquilino.id}</td>
                                ...
                                <td style="display: flex; gap: 10px; justify-content: center;">
                                    <a href="${pageContext.request.contextPath}/inquilino/editar?id=${inquilino.id}" class="btn-clear" style="text-decoration: none; padding: 6px 12px;">Editar</a>
                                    <form action="${pageContext.request.contextPath}/inquilino" method="post" onsubmit="return confirm('Tem certeza que deseja excluir este inquilino?');">
                    ...
                    <c:otherwise>
                        <tr>
                            <td colspan="5">
                                <div class="no-data">Nenhum inquilino cadastrado.</div>
                            </td>
                        </tr>
                    </c:otherwise>
                </c:choose>
